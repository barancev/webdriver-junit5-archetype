...
```
mvn archetype:generate -DarchetypeGroupId=ru.stqa.selenium -DarchetypeArtifactId=webdriver-junit5-archetype -DarchetypeVersion=4.2 -DgroupId=<mygroupId> -DartifactId=<myartifactId>
```
